...
namespace ResumeMVVMLight.ResumeParser
{
    class ResumeParse
    {
        ...
        protected void Converter(string ResumePath, string extension)
        {
            switch (extension)
            {
                case ".pdf":
                    Aspose.Pdf.Document pdfDoc = new Aspose.Pdf.Document(ResumePath);
                ...
                case ".rtf":
                    {
                        // Load in the document
                        Document doc = new Document(ResumePath);
                        //doc.Save(HttpContext.Current.Server.MapPath("Input/input.txt"));
                        doc.Save(Properties.Settings.Default.TempInFile);
                        break;
                    }
            }
            //ConvertDocument(HttpContext.Current.Server.MapPath("Input/input.txt"));
            ConvertDocument(Properties.Settings.Default.TempInFile);
        }
        ...
        public System.Data.Linq.Table<ResumeTable> GetResumeTable()
        {
